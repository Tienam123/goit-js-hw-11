...
const refs = {
    ...
    content: document.querySelector(".cat-info")
};
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = (0, _apiKey.API_KEY);
...
(0, _catApi.setOptions)((0, _catApi.fetchBreeds), (0, _apiKey.URL_BREEDS), select);
refs.select.addEventListener("change", onSelectChange);
function onSelectChange(e) {
    const newUrl = (0, _apiKey.URL_CAT) + select.getSelected().join("");
    (0, _catApi.fetchBreeds)(newUrl).then((res)=>{
        console.log(res);
        refs.content.innerHTML = `
     <div class="cat-info__image">
     <img width="300" src="${res[0].url}" alt="">
</div>
      <div class="cat-info__about">
        <h2 class="cat-info__title">${res[0].breeds[0].name}</h2>
        <p class="cat-info__description">${res[0].breeds[0].description}</p>
        <p class="cat-info__temperament"><span>Temperament:</span> ${res[0].breeds[0].temperament}</p>
      </div>
    `;
    });
}

},{"./partials/api-key":"hV54U","axios":"gIwns","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh","slim-select":"1a7Ba","slim-select/src/slim-select/slimselect.scss":"1s5GW","../scss/style.scss":"m5N6h","./cat-api":"9sqqR","./Loader":"kF5HC"}],"hV54U":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY);
parcelHelpers.export(exports, "URL_BREEDS", ()=>URL_BREEDS);
parcelHelpers.export(exports, "URL_CAT", ()=>URL_CAT);
const API_KEY = "live_jGR4DJyjCZKsVKzECOtuib6JI2a3detr4pWQg2zIj9nMR5K15dfogeVAetWkB1P3";
const URL_BREEDS = "https://api.thecatapi.com/v1/breeds";
const URL_CAT = "https://api.thecatapi.com/v1/images/search?breed_ids=";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"1a7Ba":[function(require,module,exports) {
...
},{}],"1s5GW":[function() {},{}],"m5N6h":[function() {},{}],"9sqqR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function fetchBreeds(url) {
    (0, _loaderDefault.default).close();
    return (0, _axiosDefault.default).get(url).then((response)=>{
        (0, _loaderDefault.default).open();
        ...
        setTimeout(()=>{
            ...
            (0, _loaderDefault.default).close();
            (0, _loaderDefault.default).show();
        }, 4000);
    });
}
function setOptions(promise, url, el) {
...
},{"axios":"gIwns","./Loader":"kF5HC","notiflix":"dtGP5","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"kF5HC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Loader {
    static loader = document.querySelector(".spinner-loader");
    static message = document.querySelector("#message");
    static open() {
        Loader.loader.classList.add("visually-hidden");
    }
    static close() {
        Loader.loader.classList.remove("visually-hidden");
    }
    static show() {
        Loader.message.classList.remove("visually-hidden");
    }
    static hide() {
        Loader.message.classList.add("visually-hidden");
    }
}
exports.default = Loader;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"dtGP5":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},["6kc6j","1uJD7"], "1uJD7", "parcelRequirec6ed")
